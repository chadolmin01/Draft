...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background overflow-hidden">
      ...
      >
        <div className="flex justify-between items-start">
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 bg-secondary/60 rounded-xl text-xs font-medium text-muted-foreground hover:bg-secondary/80 hover:text-foreground transition-colors">
            You are signing up for <span className="font-medium text-foreground flex items-center gap-1"><DraftLogo className="w-2.5 h-2.5" /> Draft</span>
      ...
      <div className="hidden md:flex w-1/2 bg-black relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-0 w-full h-full opacity-30">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="signup-microGrid" width="20" height="20" patternUnits="userSpaceOnUse">
                <path d="M 20 0 L 0 0 0 20" fill="none" stroke="white" strokeWidth="0.5" opacity="0.1" />
              </pattern>
              <pattern id="signup-macroGrid" width="100" height="100" patternUnits="userSpaceOnUse">
                <rect width="100" height="100" fill="url(#signup-microGrid)" />
                <path d="M 100 0 L 0 0 0 100" fill="none" stroke="white" strokeWidth="0.8" opacity="0.15" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#signup-macroGrid)" />
          </svg>
        </div>
      ...
      <AuthDialog open={authDialogOpen} onClose={() => setAuthDialogOpen(false)} initialMode="signup" />
    </div>
  );
}
